...
There are many places that needs immediate value in assembly code.
However, compile target is 64-bit but instructions have 32-bit length
format, which makes generating assembly code about immediate value
become very long. We made this process as functions.
